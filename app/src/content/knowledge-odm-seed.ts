...
const useCaseSeeds: UseCaseSeed[] = [
  ...
  },
  {
    ...
    references: [
      ...
      { name: "McKinsey AI in Product Development", detail: "20–80% acceleration in R&D knowledge-work tasks using GenAI; front-end design phases see largest gains (25–50% time reduction)." },
  ...
  },
  {
    ...
    references: [
      ...
      { name: "McKinsey AI in Product Development", detail: "15–30% time-to-market reduction for early adopters; 20–25% overall development time reduction when AI embedded across the development system." },
  ...
  },
  {
    ...
    references: [
      ...
      { name: "GenAI Sales Engineering (Multi-Industry)", detail: "50–80% reduction in proposal generation time; multi-format output adapted to customer requirements; historical win/loss analysis informing pricing strategy." },
      { name: "ODM Competitive Benchmarking (Industry Composite)", detail: "Speed-to-quote typically decisive in ODM design-win bidding; AI-assisted target: 3–5 days for initial pricing vs. 2–3 week industry average; 5–15% win rate improvement from faster, more accurate responses." },
  ...
  },
  {
    ...
    references: [
      ...
      { name: "Multi-Agent RL Smart Factories (Frontiers in Manufacturing)", detail: "Peer-reviewed MARL framework for high-mix electronics: agents coordinate across equipment for factory-level optimization; generalizes across product types and process configurations." },
    ],
    validation: DEFAULT_VALIDATION,
  },
  {
    ...
    a2aPattern: "pipeline",
    references: [
      { name: "GenAI 8D Report Automation (Electronics Manufacturing)", detail: "60–80% reduction in report generation time (3–5 days to 4–8 hours); consistent format compliance across all customer templates; engineers freed to focus on complex root cause analysis." },
      { name: "AI Quality Pattern Recognition (Multi-Industry)", detail: "2–5x more cross-product correlations vs. manual analysis; defect patterns linked to specific supplier lots, shifts, and environmental conditions; 20–35% reduction in recurring defects." },
      { name: "CAPA Automation (ISO/IATF Environments)", detail: "30–50% faster CAPA closure; 90%+ audit-ready documentation compliance vs. 60–70% with manual processes; automatic effectiveness verification via pre/post defect rate comparison." },
  ...
  },
  {
    ...
    references: [
      ...
      { name: "Electronics Contract Manufacturer AI Shortage", detail: "AI predicting component shortages 2–4 weeks ahead of impact; 25% reduction in production delays through proactive intervention; market allocation signals incorporated into prediction models." },
