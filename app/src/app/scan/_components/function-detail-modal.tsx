...
const FREED_COLOR = "bg-zinc-400 dark:bg-zinc-600";
...
export function FunctionDetailModal({ meta, onClose }: FunctionDetailModalProps) {
  ...
  return (
    ...
    >
      <div
        className="flex max-h-[90vh] w-full max-w-3xl flex-col gap-4 overflow-y-auto rounded-xl border border-zinc-200 bg-white p-6 shadow-xl dark:border-zinc-800 dark:bg-zinc-900"
      ...
      >
        <div className="flex items-start justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-md border border-zinc-200 px-2 py-1 text-xs hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-800"
          >
            {t.scan.close}
          </button>
        </div>
        ...
        {level && (
          <div className="grid gap-6 md:grid-cols-[auto_1fr]">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="rounded-md bg-zinc-100 px-3 py-2 text-center text-sm font-semibold text-zinc-800 dark:bg-zinc-800 dark:text-zinc-100">
              ...
              <div>
                ...
                <ul className="space-y-1">
                  {meta.categories.map((cat, i) => (
                    <li key={cat.key} className="flex items-center gap-2 text-xs text-zinc-700 dark:text-zinc-300">
