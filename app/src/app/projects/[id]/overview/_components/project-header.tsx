...
export function ProjectHeader({ project }: ProjectHeaderProps) {
  ...
  const inputCls =
    "w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm dark:border-slate-700 dark:bg-slate-950";
    ...
    <section className="flex items-start justify-between gap-4">
      ...
      <div className="flex shrink-0 gap-2">
        ...
        <button
          ...
          onClick={onDelete}
          disabled={deleting}
          className="inline-flex items-center gap-1.5 rounded-md border border-rose-200 bg-white px-3 py-1.5 text-sm text-rose-600 hover:bg-rose-50 disabled:opacity-40 dark:border-rose-900/50 dark:bg-slate-900 dark:text-rose-400 dark:hover:bg-rose-950/30"
        >
