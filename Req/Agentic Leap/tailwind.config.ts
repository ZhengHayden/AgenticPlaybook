    ...
    extend: {
      ...
      colors: {
        ...
        accent: {
          ...
          "violet-soft": "hsl(var(--accent-violet-soft))",
        },
        popover: {
        ...
        q1: { DEFAULT: "hsl(var(--q1))", soft: "hsl(var(--q1-soft))" },
        q2: { DEFAULT: "hsl(var(--q2))", soft: "hsl(var(--q2-soft))" },
        q3: { DEFAULT: "hsl(var(--q3))", soft: "hsl(var(--q3-soft))" },
        q4: { DEFAULT: "hsl(var(--q4))", soft: "hsl(var(--q4-soft))" },
        sidebar: {
